...
var instrucciones = [
	...
	"Esta es otra instrucción",
	"Aquí estarán todas las instrucciones"
];
...
/* DONE- Esta función deberá recorrer el arreglo de instrucciones pasado por parámetro. 
...
/* DONE- COMPLETAR: Crear función que agregue la última dirección al arreglo de movimientos
y utilice actualizarUltimoMovimiento para mostrarlo en pantalla */
function registrarUltimoMovimiento(ultimaDireccion) {
	movimientos.push(ultimaDireccion);
	actualizarUltimoMovimiento(ultimaDireccion);

}

/* DONE- Esta función va a chequear si el Rompecabezas esta en la posicion ganadora. 
...
// DONE- Implementar alguna forma de mostrar un cartel que avise que ganaste el juego
function mostrarCartelGanador() {
	alert(`Es ud. un genio. Por Dios que rapidez. \n\nLo hizo utilizando solamente ${movimientos.length-30} movimientos\n\nNi Alpha-Go es tan bueno!`)
}

/*DONE- Función que intercambia dos posiciones en la grilla.
...
function moverEnDireccion(direccion) {
	...
	if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia)) {
		...
		registrarUltimoMovimiento(direccion);
